    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="text-base lg:text-lg text-white/60 group-hover:text-white/80 transition-colors duration-300">
                  {stat.label}
                </div>
              </div>
        ...
        <div className="text-center">
          <div className="inline-block bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-12 border border-white/20 w-full max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="group relative px-10 py-4 text-lg font-bold text-black bg-gradient-to-r from-[#6C85EA] to-[#AAFDBB] rounded-full overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-[0_0_40px_rgba(108,133,234,0.6)] hover:shadow-[0_0_60px_rgba(108,133,234,0.9)] min-w-[200px]">
